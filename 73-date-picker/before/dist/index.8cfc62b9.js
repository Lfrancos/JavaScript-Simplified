...
var _toDate = require("date-fns/toDate");
var _toDateDefault = parcelHelpers.interopDefault(_toDate);
...
const dateTodayFormated = _dateFns.format(dateTodayRaw, `MMMM do, yyy`);
currentMonth.textContent = _dateFns.format(dateTodayRaw, 'MMMM - yyy');
const dateSelected = new Date();
dateButton.textContent = dateTodayFormated;
arrows.forEach((arrow)=>{
    arrow.classList.contains('prev-month-button');
});
datePicker.addEventListener('click', (e1)=>{
    ...
    dateDay.forEach((day)=>{
        day.addEventListener('click', (e)=>{
            ...
            const newDate = _dateFns.format(new Date(2020, 9, days), 'MM/dd/yyyy');
            console.log(newDate);
...
},{"date-fns":"9yHCA","date-fns/toDate":"fsust","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"9yHCA":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["jWVwA","6rimH"], "6rimH", "parcelRequire9e27")
